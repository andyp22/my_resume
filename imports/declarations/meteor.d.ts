...
declare module 'meteor/blaze' {
  ...
  export namespace Blaze {
    ...
    function render(
      templateOrView: Template | Blaze.View,
      parentNode: Node,
      nextNode?: Node,
      parentView?: Blaze.View
    ): Blaze.View;
...
declare module 'meteor/ddp' {
  export namespace DDP { function connect(url: string): DDP.DDPStatic; }
}

declare namespace DDPCommon {
  function MethodInvocation(options: {}): any;
}
...
interface CompileStep {
  addAsset(options: {}, path: string, data: any /** Buffer **/ | string): any;
  addHtml(options: { section?: string; data?: string }): any;
  addJavaScript(options: { path?: string; data?: string; sourcePath?: string }): any;
  addStylesheet(options: {}, path: string, data: string, sourceMap: string): any;
  arch: any;
  declaredExports: any;
  error(options: {}, message: string, sourcePath?: string, line?: number, func?: string): any;
  fileOptions: any;
  fullInputPath: any;
  inputPath: any;
  inputSize: any;
