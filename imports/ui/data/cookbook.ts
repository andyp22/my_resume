...
const cookbookData: IRecipe[] = [
  ...
  {
    id: '5',
    title: 'Granola with a really long name for CSS testing',
    category: 'breakfast',
    makes: '8 cups',
    image: 'images/Granola_7365.png',
    description: 'Granola is a great breakfast treat. This recipe can be used as the base for many tasty granola varieties.',
  ...
  {
    id: '6',
    title: 'Granola with a really long name for CSS testing and gotta make it even longer',
    category: 'breakfast',
    makes: '8 cups',
    image: 'images/Granola_7365.png',
    description: 'Granola is a great breakfast treat. This recipe can be used as the base for many tasty granola varieties.',
