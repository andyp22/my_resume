cookbookData = {
  sections: [
    ...
    },
    {
      ...
      style: 'background-image: url(/images/cookbook/dough4.jpg);',
      bcgDataCenter: 'background-position: 50% 0px;',
      bcgDataTopBottom: 'background-position: 50% -100px;',
      hsDataCenter: 'opacity: 1;',
      hsData100Top: 'opacity: 0;',
    ...
    },
    {
      ...
      style: 'background-image: url(/images/cookbook/dough5.jpg);',
      bcgDataCenter: 'background-position: 0px 50%;',
    ...
    },
    {
      ...
      style: 'background-image: url(/images/cookbook/dough6.jpg);',
      bcgDataCenter: 'background-position: 50% 0px;',
      bcgDataTopBottom: 'background-position: 50% -100px;',
      hsDataCenter: 'opacity: 1;',
      hsData100Top: 'opacity: 0;',
